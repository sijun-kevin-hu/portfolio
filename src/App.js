        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <a href="#skills" className="block hover:text-blue-400 transition-colors duration-300">Skills</a>
              <a href="#projects" className="block hover:text-blue-400 transition-colors duration-300">Projects</a>
              <a href="/resume.pdf" download className="block hover:text-blue-400 transition-colors duration-300">Resume</a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="p-2 bg-gray-800 rounded-full hover:bg-gray-600 transition-colors duration-300"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
