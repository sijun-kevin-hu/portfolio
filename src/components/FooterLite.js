    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="space-y-2">
            {['About', 'Skills', 'Projects'].map((item) => (
              <a
                ...
                className="block text-gray-300 hover:text-cyan-400 transition-colors duration-300 w-fit"
              >
      ...
      <div className="border-t border-cyan-500/20 mt-12 pt-8 text-center relative">
        ...
        <p className="text-gray-600 text-xs mt-4">
          Icons by
          {' '}
          <a href="https://icons8.com" target="_blank" rel="noopener noreferrer" className="text-cyan-500/70 hover:text-cyan-400 transition-colors duration-300">
            Icons8
          </a>
        </p>
      </div>
