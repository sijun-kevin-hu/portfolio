...
const InfoCard = ({ title, content, icon, delay, prefersReducedMotion }) => (
    <motion.article
...
const Introduction = () => {
    ...
    return (
        <section ref={ref} className="section-padding relative overflow-hidden py-24 sm:py-28" id="about">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <IntroCard prefersReducedMotion={prefersReducedMotion} />
