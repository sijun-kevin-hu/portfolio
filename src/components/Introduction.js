...
const IntroCard = () => {
    ...
    return (
        <div
            ref={ref}
            className={`relative w-full group ${inView ? 'anim-intro-up' : 'opacity-0'}`}
        >
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-cyan-300 font-mono text-xs sm:text-sm tracking-[0.2em] uppercase mb-4">{ABOUT_CONTENT.eyebrow}</h2>
